...
typedef struct {
	...
	volatile unsigned int _reserved0; // 0x8
	volatile unsigned int _reserved1; // 0xc
	volatile unsigned int _reserved2; // 0x10
	volatile unsigned int _reserved3; // 0x14
	volatile unsigned int FR; // 0x18
	volatile unsigned int _reserved4; // 0x1c
